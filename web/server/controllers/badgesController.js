...
// Helper function to generate SVG string for badge
...
exports.getBadgeSvg = async (req, res) => {
    try {
        ...
        // Set cache headers (cache for 5 minutes, allow revalidation)
        // GitHub caches images, so we use a short cache time and allow stale content
        res.set({
